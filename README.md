...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypickle-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14093&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypickle-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypickle` can be installed with:

```
conda install pypickle
```

It is possible to list all of the versions of `pypickle` available on your platform with:
